...
public class HomePageView extends VerticalLayout {
    ...
    Button button = new Button("Lägg till personal");
    Button button1 = new Button("Lägg till besökare");
    ...
    public HomePageView(){
        ...
        Image img=new Image("images/LIBSYS.png", "My App logo");
        viewTitle = new H1("");
        ...
        button1.addClickListener( e -> getCurrent().navigate(AddVisitorView.class));
    ...
    public void newOverlay()
        {
            ...
            overlay.addLoginListener(e -> UI.getCurrent().navigate(AddUserView.class));
